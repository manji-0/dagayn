...
<body>
  ...
  <div id="toolbar">
    ...
    <span id="truncation-warning" style="display:none;color:var(--btn-bg);font-size:11px;margin-left:8px;cursor:pointer;" title="Increase dagayn.graph.maxNodes in settings"></span>
  </div>
