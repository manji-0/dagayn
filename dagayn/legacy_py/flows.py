...
from dagayn.bridge_types import FlowStepRecord
from dagayn.constants import SECURITY_KEYWORDS as _SECURITY_KEYWORDS
from dagayn.entry_point_heuristics import has_framework_decorator, matches_entry_name
from dagayn.graph import (
    FlowAdjacency,
    GraphEdge,
    GraphNode,
    GraphStore,
...
from dagayn.state_types import AffectedFlowsResult, ChangeFlowRecord
...
def _annotate_flow_dict_bridges(store: GraphStore, flow: FlowRecord) -> FlowRecord:
    ...
    from dagayn.cross_artifact import annotate_flow_steps_with_bridges
