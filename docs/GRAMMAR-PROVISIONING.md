...
JavaScript/JSX, TypeScript/TSX, Bash, Go, Java, Ruby, C#, PHP, Kotlin, Scala, Solidity, Dart, Lua, Luau, C, C++, Objective-C, Elixir, GDScript, R, Julia, and Perl through these pinned grammar sources.
