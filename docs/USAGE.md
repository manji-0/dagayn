...
Rust, Python/notebooks, Bash/Go/Java/Ruby/C#/PHP/Kotlin/Scala/Solidity/Dart/Lua/Luau/C/C++/Objective-C/Elixir/GDScript, and core JavaScript/JSX/TypeScript/TSX files:
