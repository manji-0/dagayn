...
Bash/Go/Java/Ruby/C#/PHP/Kotlin/Scala/Solidity/Dart/Lua/Luau/C/C++/Objective-C/Elixir/GDScript/R/Julia/Perl/Vue/Svelte, plus core JavaScript/JSX/TypeScript/TSX files, set
`DAGAYN_BACKEND=rust`:
